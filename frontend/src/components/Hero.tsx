  ...
  return (
    <section id="home" className="min-h-screen pt-32 pb-20 flex flex-col items-center justify-center px-6 overflow-hidden">
      <Helmet>
        ...
        <meta property="og:title" content="柏青树" />
        ...
        >
          ...
          <div className="bg-white sketched-border p-6 shadow-comic mb-10 rotate-[-1deg]">
            <p className="text-2xl font-black leading-tight">
              你好，我是<span className="text-comic-red underline decoration-4">柏青树</span>，一个喜欢<span className="text-comic-yellow underline decoration-4">摄影</span>、正在学习<span className="text-comic-yellow underline decoration-4">AI</span>的<span className="text-comic-blue underline decoration-4">医药行业打工人</span>。
            </p>
          </div>
